...
class TestStandard1Q(QiskitTestCase):
    ...
    def test_barrier_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.barrier, 0.0)
    ...
    def test_ch_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.ch, 0.0, self.qr[0])
    ...
    def test_crz_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.crz, 0, 0.0, self.qr[0])
    ...
    def test_cswap_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.cswap, self.qr[1], 0.0, self.qr[0])
        ...
        self.assertRaises(QiskitError, qc.cswap, 0.0, self.qr[0], self.qr[1])
    ...
    def test_cu1_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.cu1, 0, 0.0, self.qr[0])
    ...
    def test_cu3_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.cu3, 0, 0, 0, self.qr[0], self.qr[0])
        self.assertRaises(QiskitError, qc.cu3, 0, 0, 0, 0.0, self.qr[0])
    ...
    def test_cx_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.cx, 0.0, self.qr[0])
    ...
    def test_cy_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.cy, 0.0, self.qr[0])
    ...
    def test_cz_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.cz, 0.0, self.qr[0])
    ...
    def test_h_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.h, 0.0)
    ...
    def test_iden_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.iden, 0.0)
    ...
    def test_rx_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.rx, 0, 0.0)
    ...
    def test_ry_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.ry, 0, 0.0)
    ...
    def test_rz_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.rz, 0, 0.0)
    ...
    def test_rzz_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.rzz, 1, 0.0, self.qr[0])
    ...
    def test_s_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.s, 0.0)
    ...
    def test_sdg_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.sdg, 0.0)
    ...
    def test_swap_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.swap, 0.0, self.qr[0])
    ...
    def test_t_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.t, 0.0)
    ...
    def test_tdg_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.tdg, 0.0)
    ...
    def test_u0_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.u0, 0, 0.0)
    ...
    def test_u1_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.u1, 0, 0.0)
    ...
    def test_u2_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.u2, 0, 0, 0.0)
    ...
    def test_u3_invalid(self):
        ...
        self.assertRaises(QiskitError, qc.u3, 0, 0, 0, 0.0)
...
class TestStandard3Q(QiskitTestCase):
    ...
    def test_ccx_reg_reg_reg(self):
        ...
        self.assertEqual(
            instruction_set.qargs[1], [self.qr[1], self.qr2[1], self.qr3[1]]
        )
        self.assertEqual(instruction_set.instructions[2].params, [])
